<template>
  <div class="container-fluid">
    ...
    <h2>Vaults <i v-if="user.id == profile.id" class="btn mdi mdi-plus-outline mdi-36px" @click="openVaultForm()" title="create new vault"></i></h2>
    ...
    <div class="row">
      <h2>Keeps <i v-if="user.id == profile.id" class="btn mdi mdi-plus-outline mdi-36px" @click="openCreateKeepForm()" title="create new keep"></i></h2>
